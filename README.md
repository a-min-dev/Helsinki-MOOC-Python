...
## Featured Portfolio
*The following selections demonstrate milestones achieved while completing the exercises outlined in the Helsinki MOOC Python & Object Oriented Programming courses:*
...
* **[analog_clock.py](./Portfolio/analog_clock.py)** - The program utilizes the pygame module to design and display an analog clock that displays the current system time
