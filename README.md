...
reads a JSON file then prints out information about a person, including the given person's name, age,
and hobbies
...
* **[shopping_list.py](./Portfolio/shopping_list.py)** - The program includes the ShoppingList class with several methods, such as a method to add an item and the the number of units associated with the item to a shopping list.  The program includes a function to determine the total number of units in a shopping list
